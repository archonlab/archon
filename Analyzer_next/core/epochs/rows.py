"""Normalize epoch telemetry rows without owning filesystem access."""
...
from Analyzer_next.core.epochs.constants import NUMERIC_COLUMNS
from Analyzer_next.core.epochs.numeric import clamp01, safe_float, safe_int
